...
- [x] Tamil case-suffix table (-ஐ, -க்கு, -இல், -ஆல்) + sandhi-joining rules for
      interpolated identifiers — suffixes are data in `lang/case_suffixes.toml`,
...
- [x] Native-speaker panel (tech/coder friends, decision C3) reviewed the section 3 word-order table and the rendered error messages — **C3 ratified 2026-06-15**: keyword table finalized to v1 and the Tamil/Tanglish catalog (`lang/messages.toml`, 33/36 codes) authored from the review.
