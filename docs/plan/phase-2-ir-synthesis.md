...
- [x] Design the **external Verilog wrapping** construct (Constitution: emit + wrap Verilog) - spec bump + Decision log required before any code,
      ...
      **✅ DONE 2026-07-15 (spec/02 section 1.5c)** - `extern module Name(params) { doc: "...", ports }`,
...
- [x] Design explicit CDC construct (`sync`) - spec update + Decision log entry
      **✅ DONE 2026-07-20 (spec/02 section 1.2b, E0702–E0705)** - `sync.double_flop`
...
- [x] **Packages / namespacing** (gap section 10 - NEW) - modest module-namespacing
      ...
      **✅ DONE 2026-07-02 (spec/02 v0.2.19, section 1.5b)** - per-file module/enum/bundle
...
- [x] **Enum Variant Construction (Payload)** - follow-up to Tagged Unions (2.7):
      ...
      error codes (E0806/E0401 reused) - **✅ DONE 2026-07-14 (spec/02 section 5a)** -
...
- [x] **Structural interface matching (2.9)** - `A`/`B` bundles with
      ...
      **✅ DONE 2026-07-16** (branch `phase-2-structural-interface-matching`,
      spec/02 section 1.12, new E0910) - also fixed a pre-existing bug where
...
- [ ] **Bundle-typed `fn` return via inlining** (new, discovered 2026-07-16
      ...
      honest gap (spec/02 section 1.12 documents it as open, not silently broken).
- [x] **`?` valid-bundle sugar (2.1 re-targeted)** - `bit?`/`bits[N]?`/
      ...
      the simulator. **✅ DONE 2026-07-17 (spec/02 v0.2.26, new section 1.12a)** - `crates/mimz-core/src/checker/tests.rs`,
...
- [x] **`clog2` const-builtin** (noted in `phase-4-ecosystem.md` stdlib +
      ...
      `feat/clog2-const-builtin`, spec/02 section 1.8 v0.2.13): exposes the ceil-log2
