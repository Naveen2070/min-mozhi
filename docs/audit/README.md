...
| [`review-2026-08-18.md`](review-2026-08-18.md) | v0.2.0-rc1 readiness round 8 — **no-go**, light-touch four-check round per [`round-8-suggestion.local.md`](round-8-suggestion.local.md); items 2/4 (diagnose-not-panic, BUG-67) verified fixed on a release build, item 3 fixed for its own three repros, corpus clean 226/50/90/0, gate 5 clean at 5000/5000 — but item 1's declaration-order invariant is shown to be **name-specific, not axis-level** (broken on two constructed cases, `BUG-70`), and item 5's own filed repro still fails (`BUG-71`, `emit_testbench` never folds file-level consts into its env)                                                                                                                                                                                                                                                                                |
