...
**1034 tests** as of 2026-07-26 (`cargo test-summary --workspace`): 607
mimz-core lib unit + 155 mimz-sim lib unit + 51 mimz (root) lib unit + 0
mimz-wasm lib unit + 7 mimz bin unit + 6 mimz-bench bin unit + 0 doctests
(×4 crates) + 6 cli integration + 14 compile_string integration + 7 config
integration + 4 differential_fuzz + 4 docs_sync + 4 errors + 15 eval
integration + 13 examples integration + 5 extern integration + 9 fmt
integration + 16 grammar integration + 6 grammar_sync + 10 icarus
differential + 1 lsp + 20 morph integration + 2 packages integration + 12
self_determined_regression + 6 showcase integration + 17 sim integration +
11 stdlib integration + 7 test_run integration + 15 translate integration +
2 wasm_parity + 2 width_rules_conformance.

Fixture counts (current): 106 error fixtures · 8 grammar fixtures · 70 golden `.v` outputs + 14 `_tb.v` testbench goldens + 1 `.vcd` · 45 Icarus self-checking testbenches.
