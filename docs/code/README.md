...
```text
 ...
 [ast::File] ──checker::check──▶ names/consts/rules verified (E-codes;
                                 fn safety E0801–E0812, bundles E0901–E0909)
