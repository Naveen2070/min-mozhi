...
| `test_count_matches_docs_and_badge`                 | the total test count in `docs/code/10-test-map.md`, the `README.md` badge, and `ROADMAP.md`'s v0.2.0 reference all agree (currently 1315 tests) |
