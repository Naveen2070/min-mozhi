...
pub fn zeros(width: u32) -> Vec<u64> {
...
pub fn mask_to_width(limbs: &mut [u64], width: u32) {
...
/// limbs.
pub fn from_u128(v: u128, width: u32) -> Vec<u64> {
...
pub fn bit_at(limbs: &[u64], i: u32) -> bool {
...
pub fn extend(limbs: &[u64], from_width: u32, to_width: u32, signed: bool) -> Vec<u64> {
...
pub fn cmp_unsigned(a: &[u64], b: &[u64]) -> std::cmp::Ordering {
...
pub fn cmp_signed(a: &[u64], b: &[u64], width: u32) -> std::cmp::Ordering {
...
pub fn add(a: &[u64], b: &[u64], result_width: u32) -> Vec<u64> {
...
/// caveat as `add`.
pub fn sub(a: &[u64], b: &[u64], result_width: u32) -> Vec<u64> {
    let mut out = zeros(result_width);
...
pub fn neg(a: &[u64], width: u32) -> Vec<u64> {
...
/// Assumes inputs are canonical (masked to their declared width) — same
/// caveat as `add`.
pub fn mul(a: &[u64], b: &[u64], result_width: u32) -> Vec<u64> {
...
pub fn to_decimal_string(limbs: &[u64], width: u32, signed: bool) -> String {
...
pub fn shl(a: &[u64], amount: u32, result_width: u32) -> Vec<u64> {
    let mut out = zeros(result_width);
...
pub fn shr(a: &[u64], amount: u32) -> Vec<u64> {
...
pub fn bitand(a: &[u64], b: &[u64]) -> Vec<u64> {
    a.iter().zip(b).map(|(x, y)| x & y).collect()
}
pub fn bitor(a: &[u64], b: &[u64]) -> Vec<u64> {
    a.iter().zip(b).map(|(x, y)| x | y).collect()
}
pub fn bitxor(a: &[u64], b: &[u64]) -> Vec<u64> {
    a.iter().zip(b).map(|(x, y)| x ^ y).collect()
}
...
pub fn to_binary_string(limbs: &[u64], width: u32) -> String {
