...
> For the complete set of repository working rules, always refer to [docs/RULES.md](../docs/RULES.md).
...
- **References**:
  - **Philosophy & Goals**: [spec/01-goals-and-philosophy.md](../spec/01-goals-and-philosophy.md)
  - **Syntax & Grammar**: [spec/02-syntax-and-grammar.md](../spec/02-syntax-and-grammar.md)
