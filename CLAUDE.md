...
- Refer to the codebase rules in [.claude/Rules.md](.claude/Rules.md) and [docs/RULES.md](docs/RULES.md) before making any changes. If `.claude/Rules.md` is not found, use [.agents/Rules.md](.agents/Rules.md) as the fallback.

## Agent Instructions

@AGENTS.md

See [AGENTS.md](AGENTS.md) for detailed agent instructions and persona guidelines.
